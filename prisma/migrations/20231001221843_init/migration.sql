/*
  ...
  - You are about to drop the column `authCode` on the `users` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `users` DROP COLUMN `authCode`,
    ADD COLUMN `passResetHash` VARCHAR(191) NULL,
    ADD COLUMN `verifyEmailHash` VARCHAR(191) NULL,
