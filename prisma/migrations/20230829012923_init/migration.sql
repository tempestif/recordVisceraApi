/*
  ...
  - You are about to alter the column `createdAt` on the `Weights` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  - You are about to alter the column `updatedAt` on the `Weights` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
...
*/
-- AlterTable
ALTER TABLE `Weights` MODIFY `createdAt` DATETIME NOT NULL DEFAULT NOW(),
...
-- AlterTable
ALTER TABLE `profiles` MODIFY `birthday` DATE NULL,
