/*
  ...
  - A unique constraint covering the columns `[name]` on the table `user_medication_info` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `user_medication_info_name_key` ON `user_medication_info`(`name`);
