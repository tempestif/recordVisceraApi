/*
  ...
  - You are about to alter the column `createdAt` on the `daily_report_anorectal_lesions` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  - You are about to alter the column `updatedAt` on the `daily_report_anorectal_lesions` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  ...
  - Added the required column `score` to the `abdominal_scale_types` table without a default value. This is not possible if the table is not empty.
  - Added the required column `score` to the `condition_scale_types` table without a default value. This is not possible if the table is not empty.
  - Added the required column `score` to the `stomachache_scale_types` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `abdominal_scale_types` ADD COLUMN `score` INTEGER NOT NULL;
...
-- AlterTable
ALTER TABLE `condition_scale_types` ADD COLUMN `score` INTEGER NOT NULL;
...
-- AlterTable
ALTER TABLE `daily_report_anorectal_lesions` MODIFY `createdAt` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updatedAt` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW();
...
-- AlterTable
ALTER TABLE `stomachache_scale_types` ADD COLUMN `score` INTEGER NOT NULL;
